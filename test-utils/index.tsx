...
const Field: React.FC<Record<string, any> & { field: FormField<any> }> = (
  props,
) => {
  const { field } = props;
  const { onChange, error, dirty, value, required, onBlur, name } =
...
const Form = <T extends Record<string, any>>({
  ...
  FormProps<T>,
  "onSubmit" | "onSubmitFinished" | "onSubmitFailed" | "version" | "validation"
> & {
